...
--this is a script file controlling themes
--This is the theme.lua I'd like to move to
--beautiful.init(config_dir .. "/theme.lua")

--This is the powerarrow version
...
vicious.register( batwidget, vicious.widgets.bat, '<span background="#92B0A0" font="Inconsolata 11"><span font="Inconsolata 11" color="#FFFFFF" background="#92B0A0">$1$2% </span></span>', 61, "BAT1" )
...
--"/home ${/home avail_p} %free",
--'<span background="#D0785D" font="Inconsolata 11"> <span font="Inconsolata 11" color="#EEEEEE">${/ size_mb},${/home size_mb}.${/home used_gb}/${/home avail_gb} GB </span></span>', 
'<span background="#D0785D" font="Inconsolata 11"> <span font="Inconsolata 11" color="#EEEEEE">${/ avail_gb}/${/ used_gb} GB </span></span>', 
800)
...
--'<span background="#4B3B51" font="Inconsolata 11"><span font="Inconsolata 11" color="#EEEEEE"> Vol:$1 </span></span>', 10, "IEC958")
'<span background="#4B3B51" font="Inconsolata 11"><span font="Inconsolata 11" color="#EEEEEE"> Vol:$1 </span></span>', 10, "-D pulse sget Master")
...
--{{--| Mail widget |---------
--Canceled until I figure out how to encrypt password--
--[[
...
for s = 1, screen.count() do
    ...
    left_layout:add(mylauncher) -- is this being included #DEBUG
...
clientkeys = awful.util.table.join(
	...
	--from old config
	--there are other hotkeys I haven't moved over
...
--try this version from old config:
--awful.util.spawn_with_shell("redshift-gtk -c /home/christopher/.config/redshift.conf")
...
--from old
--run_once("pgrep -u $USER -x nm-applet > /dev/null || (nm-applet &)")
run_once("redshift-gtk -c /home/christopher/.config/redshift.conf")
run_once("nm-applet")
